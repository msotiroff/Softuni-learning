namespace SimpleMvc.Framework.Routers
{
    ...
    public class ControllerRouter : IHandleable
    {
            ...
            string actionName)
        {
            ...
            {
                var requireAuthorization = methodInfo.GetCustomAttribute<PreAuthorizeAttribute>() != null;
                if (requireAuthorization && !controller.User.IsAuthenticated)
                {
                    throw new UnauthorizedException("You have to be authorized in order to access this resourse!");
                }
