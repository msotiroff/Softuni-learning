namespace HTTPServer.Routing
{
    ...
    public class ServerRouteConfig : IServerRouteConfig
    {
        ...
        {
            this.ApplicationDirectory = appRouteConfig.AppDirectory;

            this.AnonymousPaths = new HashSet<string>(appRouteConfig.AnonymousPaths);

            this.AllowedFolders = new HashSet<string>(appRouteConfig.AllowedFolders);
        ...
        public ICollection<string> AllowedFolders { get; }
