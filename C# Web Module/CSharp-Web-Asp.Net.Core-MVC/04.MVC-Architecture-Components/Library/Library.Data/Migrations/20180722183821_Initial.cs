        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBorrowed = table.Column<bool>(nullable: false),
                    YouTubeTrailerId = table.Column<string>(maxLength: 11, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookStatuses_Borrowers_BorrowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieStatuses_Borrowers_BorrowerId",
                        column: x => x.BorrowerId,
                        principalTable: "Borrowers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieStatuses_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookStatuses_BorrowerId",
                table: "BookStatuses",
                column: "BorrowerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieStatuses_BorrowerId",
                table: "MovieStatuses",
                column: "BorrowerId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieStatuses_MovieId",
                table: "MovieStatuses",
                column: "MovieId");
        }
